...
#----------------------------------------------------------------------------#
#---------------------------------- TUBE 1 ----------------------------------#
solver1 = STT_Solver(degree=5, dimension=2, time_step=0.1, min_tube_thickness=0.42, max_tube_thickness=0.45)
...
#----------------------------------------------------------------------------#
#---------------------------------- TUBE 2 ----------------------------------#
solver2 = STT_Solver(degree=5, dimension=2, time_step=0.05, min_tube_thickness=0.42, max_tube_thickness=0.45)

T1_constraints_list = reach(solver2, 8, 9, 14, 15, 3.5, 4)
T2_constraints_list = reach(solver2, 14, 15, 8, 9, 6, 7)
...
solver2.join_constraint(tube1, solver1, 3.5)
tube2 = solver2.find_solution()
print("---------------------------------")
print("CHECKER: ", solver1.real_gammas(3.5, tube1), solver2.real_gammas(3.5, tube2))
print("CHECKER: ", solver1.real_gamma_dot(3.5, tube1), solver2.real_gamma_dot(3.5, tube2))

#----------------------------------------------------------------------------#
#---------------------------------- TUBE 3 ----------------------------------#
solver3 = STT_Solver(degree=5, dimension=2, time_step=0.1, min_tube_thickness=0.42, max_tube_thickness=0.45)

T2_constraints_list = reach(solver3, 14, 15, 8, 9, 6.5, 7)
T3_constraints_list = reach(solver3, 8, 9, 14, 15, 9, 10)
for T2 in T2_constraints_list:
...
solver3.join_constraint(tube2, solver2, 6.5)
tube3 = solver3.find_solution()
print("---------------------------------")
print("CHECKER: ", solver2.real_gammas(6.5, tube2), solver3.real_gammas(6.5, tube3))
print("CHECKER: ", solver2.real_gamma_dot(6.5, tube2), solver3.real_gamma_dot(6.5, tube3))

#----------------------------------------------------------------------------#
#---------------------------------- TUBE 4 ----------------------------------#
solver4 = STT_Solver(degree=5, dimension=2, time_step=0.1, min_tube_thickness=0.42, max_tube_thickness=0.45)

T3_constraints_list = reach(solver4, 8, 9, 14, 15, 9.5, 10)
T4_constraints_list = reach(solver4, 14, 15, 8, 9, 12, 13)
...
solver4.join_constraint(tube3, solver3, 9.5)
tube4 = solver4.find_solution()
print("---------------------------------")
print("CHECKER: ", solver2.real_gammas(9.5, tube2), solver3.real_gammas(9.5, tube3))
print("CHECKER: ", solver2.real_gamma_dot(9.5, tube2), solver3.real_gamma_dot(9.5, tube3))

#----------------------------------------------------------------------------#
#---------------------------------- TUBE 5 ----------------------------------#
solver5 = STT_Solver(degree=5, dimension=2, time_step=0.1, min_tube_thickness=0.42, max_tube_thickness=0.45)

T4_constraints_list = reach(solver5, 14, 15, 8, 9, 12.5, 13)
G_constraints_list = reach(solver5, 18, 19, 18, 19, 17, 18)
...
solver5.join_constraint(tube4, solver4, 12.5)
tube5 = solver5.find_solution()
print("---------------------------------")
print("CHECKER: ", solver2.real_gammas(12.5, tube2), solver3.real_gammas(12.5, tube3))
print("CHECKER: ", solver2.real_gamma_dot(12.5, tube2), solver3.real_gamma_dot(12.5, tube3))
